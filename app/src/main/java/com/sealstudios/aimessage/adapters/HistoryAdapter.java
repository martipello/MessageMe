...
import com.sealstudios.aimessage.MainActivity;
import com.sealstudios.aimessage.Objects.ChatUser;
import com.sealstudios.aimessage.Objects.HistoryItem;
            ...
            public void successCallback(String channel, Object message) {
                ...
                try {
                    ...
                    for(int i=0; i< historyArray.length(); i++){
                        ...
                        String userName = historyJson.getString(Constants.JSON_CALL_USER_ID);
