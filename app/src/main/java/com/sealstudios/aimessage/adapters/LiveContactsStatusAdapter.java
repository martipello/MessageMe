...
public class LiveContactsStatusAdapter extends RecyclerView.Adapter<LiveContactsStatusAdapter.MyViewHolder>{
    ...
    public LiveContactsStatusAdapter(ArrayList<DatabaseContacts> contactList, Context context, ContactsActivity.OnItemTouchListener onItemTouchListener, ContactsActivity.OnImageTouchListener onImageTouchListener){
