...
@Entity
public class DatabaseContacts implements Parcelable {

    public static final Creator CREATOR = new Creator() {
        public DatabaseContacts createFromParcel(Parcel parcel) {
            return new DatabaseContacts(parcel);
        }

        public DatabaseContacts[] newArray(int size) {
            return new DatabaseContacts[size];
        }
    };
    ...
    public boolean equals(Object otherUserObject) {
        if (!(otherUserObject instanceof DatabaseContacts)) {
            return false;
        }
        DatabaseContacts that = (DatabaseContacts) otherUserObject;
    ...
    private DatabaseContacts(Parcel in){
    ...
    public static class DatabaseContactsList {
        private List<DatabaseContacts> databaseContactsList;
        public List<DatabaseContacts> getUserObjectList() {
            return databaseContactsList;
        }
    }
}